#!/usr/bin/env node
/**
 * Opens UiGuidelinesStore (triggers auto-seed if empty), prints entity count and sample ui_token.
 */
...
console.log("ui_token(primary):", JSON.stringify(tok));
const spec = await store.getSectionSpec("hero");
console.log("ui_section_spec(hero) keys:", spec && typeof spec === "object" ? Object.keys(spec) : spec);
